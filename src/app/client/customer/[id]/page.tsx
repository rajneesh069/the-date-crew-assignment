...
export default function CustomerProfile() {
  ...
  console.log();
  const customer = getProfileById(id);
  console.log(id);
          ...
          <CardContent className="p-6">
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                ...
                {customer.bio && (
                  <p className="mt-4 text-sm text-gray-600">{customer.bio}</p>
                )}
              </div>
            </div>
          </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{customer.designation}</p>
                </div>
                <div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={preferenceColors[customer.wantKids]}>
                    {customer.wantKids}
                  </Badge>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={preferenceColors[customer.openToRelocate]}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={preferenceColors[customer.openToPets]}>
                    {customer.openToPets}
                  </Badge>
                </div>
              </div>
