...
import { dummyProfiles, type FullCustomerProfile } from "@/lib/dummy-profiles";
...
const customerSchema = z.object({
  ...
  maritalStatus: z.enum(["Never Married", "Divorced"], {
    required_error: "Please select marital status",
  }),
  languages: z.string().min(2, "Language(s) are required"),
  ...
  importanceOfCasteOfThePartner: z.enum(["HIGH", "MEDIUM", "LOW"], {
    required_error:
      "Please select the importance of the caste of your partner.",
  }),
  importanceOfReligionOfThePartner: z.enum(["HIGH", "MEDIUM", "LOW"], {
    required_error:
      "Please select the importance of the religion of your partner.",
  }),
});
...
export function AddCustomer() {
  ...
  const onSubmit = async (data: CustomerFormData) => {
    ...
    try {
      ...
      const newCustomer: FullCustomerProfile = {
        ...data,
        id: `customer_${Date.now()}`,
        accountStatus: "new" as const,
        ...
        income: Number(data.income.replace(/,/g, "")),
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g. 173 cm" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="e.g. Hiking, Reading, Programming, Gym"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
              ...
              <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          {INDIAN_MAJOR_RELIGIONS.map((religion) => (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Importance of the caste of your partner
                      </FormLabel>
                      <Select
                        onValueChange={field.onChange}
                        defaultValue={field.value}
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Medium">
                            Preferrably the same.
                          </SelectItem>
                          <SelectItem value="LOW">
                            Different caste could work.
                          </SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Importance of the religion of your partner
                      </FormLabel>
                      <Select
                        onValueChange={field.onChange}
                        defaultValue={field.value}
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Bio and additional details</CardDescription>
              </CardHeader>
              <CardContent>
                <FormField
                  control={form.control}
